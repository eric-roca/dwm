...
static const char dmenufont[]       = "Fira Code Nerd Font:pixelsize=12:antialias=true:autohint=true";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-c", "-l 10", "-fn", dmenufont, "-nb", norm_bg, "-nf", norm_fg, "-sb", sel_bg, "-sf", sel_fg, topbar ? NULL : "-b", NULL };
...
static const Key keys[] = {
	...
	/* Own programs                                                        */
	{ MODKEY,                       XK_minus,  spawn,          SHCMD("dwm-volume -d; pkill -RTMIN+2 nblock") },
	{ MODKEY,                       XK_equal,  spawn,          SHCMD("dwm-volume -u; pkill -RTMIN+2 nblocks") },
	{ MODKEY,                       XK_0,      spawn,          SHCMD("dwm-volume -m; pkill -RTMIN+2 nblocks") },
